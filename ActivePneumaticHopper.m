% ACTIVE_Pneumatic_Hopper - Model the movement of a vertical hopper as a
% system of air-spring, mass, and damper. This model injects air into the
% air-spring at the bottom of the stance phase to compenstate for the
